...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="analysis_styles.css">
    ...
    <script async defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDxv4bVHpxdauO3Huermqgoy86jPun8BUQ&callback=initMap"
...
<div class="outer-container">
    ...
    <div id="category_plot" style="min-width: 600px; height: 600px; max-width: 600px;"></div>
    <div id="timeline_plot" style="min-width: 600px; height: 400px; max-width: 600px;"></div>
    ...
    <div id="map_canvas" style="width:90%; height:500px">
    </div>
</div>
</body>
</html>
